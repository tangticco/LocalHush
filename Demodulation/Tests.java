...
import Demodulation.FasterFFT;

import java.util.Random;

import static Demodulation.Library.MODE_LONG;
...
public final class Tests {
    ...
    public static void FIR(){
        ...
        System.out.println(TAG+ "Time To Filter: " + (e - s) + "ms");
        System.out.println(TAG+ "Before: " + Library.toString(signal));
        System.out.println(TAG+ "After: " + Library.toString(filteredSignal));
    ...
    public static void randomFFTTest(){
        ...
        System.out.println(TAG+ "Finshed in " + t + "ms");
    }
    ...
    public static void staticFFTTest(){
        ...
        //System.out.println(TAG+ inout.toString());
        //System.out.println(TAG+ testAns.toString());

        boolean flag = true;
        for(int i = 0; i < ans.length; i++){
            if(!ans[i].equals(FFTtestAns[i])){
                flag = false;
                System.out.println(TAG+ "Result Incorrect!!  Index: " + i + "  ans[i]: " + ans[i] + "  testAns[i]: " + FFTtestAns[i]);
            }
        }

        if(flag){
            System.out.println(TAG+ "Result Correct!");
        }
    }
    ...
    public static void FFTSinTest(){
        ...
        System.out.println(TAG+ "y[0]: " + y[0] + "  y[1]: " + y[1] + "  y[2]: " + y[2]);
        System.out.println(TAG+ "abs y[0]: " + y[0].abs() + "  y[1]: " + y[1].abs());
        ...
        System.out.println(TAG+ "int fftData[0]: " + fftData[0] + "  fftData[1]: " + fftData[1] + "  fftData[2]: " + fftData[2]);
    ...
    public static void finiteIntCacheTest(){
        ...
        System.out.println(TAG+ fic.toString());
        System.out.println(TAG+ "wrapped: " + fic.isWrapped());
        fic.insert(4);
        System.out.println(TAG+ "inserted 4: " + fic.toString());
        System.out.println(TAG+ "avg: " + fic.getAVG());
        System.out.println(TAG+ "wrapped: " + fic.isWrapped());
        fic.insert(5);
        System.out.println(TAG+ "inserted 5: " + fic.toString());
        System.out.println(TAG+ "avg: " + fic.getAVG());
        System.out.println(TAG+ "wrapped: " + fic.isWrapped());
        fic.insert(2);
        System.out.println(TAG+ "inserted 2: " + fic.toString());
        System.out.println(TAG+ "avg: " + fic.getAVG());
        System.out.println(TAG+ "wrapped: " + fic.isWrapped());
        fic.insert(24);
        System.out.println(TAG+ "inserted 24: " + fic.toString());
        System.out.println(TAG+ "avg: " + fic.getAVG());
        System.out.println(TAG+ "wrapped: " + fic.isWrapped());
    }
    ...
    public static void analyzeError(String binary, int mode){
        ...
        System.out.println(TAG+ "--- Pre ECC Errors ---------------------------------------");
        ...
        for(int i = 0; i < 3; i++){
            ...
            //System.out.println(TAG+ "Batch: " + batch);
            // 8 = parity bits in each frame
            String tmp = ECC.eccImplementation(batch, 8);
            eccOut = eccOut + tmp;
            //System.out.println(TAG+ "ECC part:" + tmp);
        }
        ...
        System.out.println(TAG+ "bitsA length: " + bitsA.length() + "   bitsP length: " + bitsP.length() + "   binary length: " + binary.length() + "   gndTruth length: " + gndTruth.length());

        // Amplitude analysis
        System.out.println(TAG+ "Amplitude Error");
        Library.printErrorAnalysis(bitsA, gndA);
        System.out.println(TAG+ " ");

        // Phase analysis
        System.out.println(TAG+ "Phase Error");
    ...
    public static void analyzeAfterECCError(String binary, int mode){
        ...
        System.out.println(TAG+ "--- Post ECC Errors -------------------------------------");
    ...
    public static void decodeTextMessageTest(String binary){
        ...
        System.out.println(TAG+ "Size is " + String.valueOf(size));

        if(10+size*8 < 441){
            String dataBinary = binary.substring(10, 10+size*8);
            String asciiString = Library.binary2ascii(dataBinary);

            System.out.println(TAG+ "Converted back is " + asciiString);
        }
    ...
    public static void virtualPhaseTest(){
        ...
        System.out.println(TAG+ "vPhase at idx+1: " +  sc.calcVirtualPhase(1));

    }

    public static void printTest(){
        System.out.println(TAG+ "This is just a test!");
    }
    ...
    public static void eccTest(String gndTruthString){
        ...
        for(int j = 0; j<100; j++){
            ...
            for(int i = 0; i < 2; i++){
                ...
                System.out.println(TAG+ "Error Location is " + String.valueOf(errorLocation));
            }
        ...
        if(sum == 100){
            System.out.println(TAG+ "ECC TEST WORKING FOR SINGLE ERROR CORRECTION!!!!!");
        }else{
            System.out.println(TAG+ "ECC TEST NOT WORKING FOR SINGLE ERROR CORRECTION!!!!!");
            System.out.println(TAG+ "Sum is " + String.valueOf(sum));
        }
        ...
        Thread producer = new Thread(new Runnable(){
            ...
            public void run() {
                ...
                while(true){
                    ...
                    resp = data.offer(c++);
                    if(!resp){
                        System.out.println(TAG+ "List is full!  Cannot insert!");
                    }
                    try {
                        Thread.sleep(2000);
